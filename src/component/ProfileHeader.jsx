        ...
        <div className="w-full h-64 bg-gradient-to-r from-blue-500 to-indigo-600 relative overflow-hidden">
          ...
          {editable && (
            <div className="absolute bottom-4 right-4">
              <label 
                htmlFor="coverUpload" 
                className="flex items-center gap-2 bg-white hover:bg-gray-100 px-4 py-2 rounded-lg shadow-md cursor-pointer text-sm font-medium transition-colors duration-200"
              >
          ...
          <div className="flex flex-col md:flex-row items-center md:items-end gap-6 -mt-20">
              ...
              {editable && (
                <div className="absolute -bottom-2 left-1/2 transform -translate-x-1/2">
                  <label 
                    ...
                    className="flex items-center justify-center bg-indigo-600 hover:bg-indigo-700 text-white p-3 rounded-full cursor-pointer shadow-lg transition-colors duration-200"
                  >
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
            ...
            <div className="text-center md:text-left flex-1 mb-6">
              ...
              <div className="flex gap-8 justify-center md:justify-start mt-6">
                <div 
                  className="text-center cursor-pointer hover:text-indigo-700 transition-colors duration-200"
                    ...
                    <li key={connection._id} className="py-4 hover:bg-gray-50 px-2 rounded-lg transition-colors duration-200">
                      <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-4">
                          <img
                            src={connection.user.profilePhoto || "/default-profile.png"}
